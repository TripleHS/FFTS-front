...
const Item1 = () => {
    return(
        <div className='flex flex-col'>
            <img className='opacity-80 rounded-l-lg' src='https://images.pexels.com/photos/3985170/pexels-photo-3985170.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260'/>
...
const Item2 = () => {
    return(
        <div className="flex flex-col">
            <img className='opacity-80 rounded-l-lg' src='https://images.pexels.com/photos/13861/IMG_3496bfree.jpg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260'/>
            <div className="flex flex-col mx-auto my-2">
...
const Item3 = () => {
    return(
        <div className="flex flex-col">
            <img className='opacity-80 rounded-l-lg' src='https://images.pexels.com/photos/3845983/pexels-photo-3845983.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'/>
            <div className="flex flex-col mx-auto my-2">
