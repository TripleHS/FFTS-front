...
const Item1 = () => {
    return(
        <div className='flex flex-col'>
            <img className='opacity-80 rounded-t-lg' src='https://images.pexels.com/photos/3985170/pexels-photo-3985170.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260'/>
...
const Item2 = () => {
    return(
        <div className="flex flex-col">
            <img className='opacity-80 rounded-t-lg' src='https://images.pexels.com/photos/13861/IMG_3496bfree.jpg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260'/>
            <div className="flex flex-col mx-auto my-2">
...
const Item3 = () => {
    return(
        <div className="flex flex-col">
            <img className='opacity-80 rounded-t-lg' src='https://images.pexels.com/photos/3845983/pexels-photo-3845983.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'/>
            <div className="flex flex-col mx-auto my-2">
                <p className='text-2xl text-footer text-center mb-4'>USŁUGI STOMATOLOGICZNE</p>
                <p className='text-xl text-footer text-center mb-4'>Zapisz się na bezpłatną wizytę i zasięgnij porady lekarskiej</p>
                <Button variant="outlined" color='primary' className='max-w-xs self-center'>SPRAWDŹ WOLNE TERMINY</Button>
            </div>
        </div>
    )
