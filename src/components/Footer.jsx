    ...
    return(
      <footer>
        <div className='pt-2 bg-footer'>
          ...
          <div className='flex flex-col'>
            <div className='flex justify-center'>
              <div className='flex mx-4'>
                ...
                <p className="m-auto text-white">Adres:<br/>ul. Zbyszka z Bogdańca 15<br/>80-783 Gdańsk</p>
              </div>
              <div className='flex mx-4'>
                <img className="w-8 h-8 m-4" src={phone} alt="phone"/>
                <p className="m-auto text-white">Infolinia:<br/>874 459 985</p>
              </div>
              <div className='flex mx-4'>
                <img className="w-8 h-8 m-4" src={clock} alt="clock"/>
                <p className="m-auto text-white">Infolinia czynna w godzinach:<br/>pn-pt: 6:00-18:00<br/>sob: 10:00-14:00</p>
              </div>
            </div>
          ...
          <p className='text-center pb-4 text-white'>Copyright © 2021 FarFromTheStretchers. All rights reserved </p>
        </div>
      </footer>
    );
}
